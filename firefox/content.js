...
waitForElementToDisplay("div#obsah._loadingContainer:nth-child(10) > div > main > div",function Main(){ 
    ...
    createBt(language != "cs", "EN", "btEn", function () {changeLanguage(this)}, document.getElementById("settingsMenuDiv"))
    document.getElementById("btEn").style.cssText += "margin-left: 0px; border-radius: 0px 16px 16px 0px;"
    ...
    document.getElementById("predictorMenuDiv").style.cssText = 'padding-top: 10px;'

    createBt(true, msg.addMark, "btAddMark", addMarkButton, document.getElementById("predictorMenuDiv"))
    document.getElementById("btAddMark").style.cssText += 'border-radius: 0px;'

    createElement("select", "selectSubject", document.getElementById("predictorMenuDiv"), "height: 32px; padding: 0px 15px; -webkit-appearance: auto;")

    for (let i = 0; i < allSubjects.length; i++) {
        
        let optionCreate = document.createElement("option")
        optionCreate.text = allSubjects[i]
        document.getElementById("selectSubject").appendChild(optionCreate)
    }

    document.getElementById("selectSubject").addEventListener("change", ifSelectedSubjectIsProgramovani, false)
    
    createElement("input", "inputMark", document.getElementById("predictorMenuDiv"), "width: 50px;")
    createElement("input", "inputWeight", document.getElementById("predictorMenuDiv"), "width: 60px;")
    
    ifSelectedSubjectIsProgramovani()

    createBt(removeMarksOn, msg.removeMarks, "btRemoveMarks", removeMarkButton, document.getElementById("predictorMenuDiv"))
    createBt(instaRemoveMarksOn, msg.instaRemoveMarks, "btInstaRemoveMarks", instaRemoveMarkButton, document.getElementById("predictorMenuDiv"))
    ...
    function addMarkButton () {
        ...
        document.getElementById("addedMark").outerHTML = ` <div class="znamka-v tooltip-bubble addedMark" style="float: left; list-style: none; position: relative; width: 56px; background-color: #ffa50069;" id="addedMark">
        ...
        document.getElementById("addedMark").addEventListener("click", function () { removeMark(this) } , false)

        document.getElementById("addedMark").id = ""
    ...
    function wideModeButton () {
        ...
        if (wideModeOn) {
            ...
            try {document.getElementById("btWideMode").style.cssText += 'background: #fff; color: #00A2E2;'} catch (error) {}
        }
        else {
            
            document.querySelector("div#obsah._loadingContainer:nth-child(10) > div").setAttribute("style", "max-width: 10000px")
            
            try {document.getElementById("btWideMode").style.cssText += 'background: #00a2e2; color: #ffff'} catch (error) {}
        }
    ...
    function hugeMarksButton () {
        ...
        try {document.getElementById("btHugeMarks").style.cssText += hugeMarksOn ? 'background: #00a2e2; color: #ffff;' : 'background: #fff; color: #00A2E2;'} catch (error) {}
    ...
    function hideWeightFromMarksWithPoints () {
        ...
        if (document.getElementById("btHideWeightFromPoints")) {
            if (hideWeightFromPointsOn) document.getElementById("btHideWeightFromPoints").classList.remove("ext-disabled")
            else document.getElementById("btHideWeightFromPoints").classList.add("ext-disabled")
        }
    ...
    function predictorMenu () {
        ...
        if (predictorOn) {
            ...
            document.getElementById("btPredictor").classList.add("ext-disabled")
        }
        else {
            predictorMenuHeaderSelector.style.cssText = 'padding-top: 0px; padding-bottom: 0px;'
            document.getElementById("btPredictor").classList.remove("ext-disabled")
        }
    ...
    function removeMarkButton () {
        ...
        if (removeMarksOn) document.getElementById("btRemoveMarks").classList.remove("ext-disabled")
        else document.getElementById("btRemoveMarks").classList.add("ext-disabled")
    ...
    function instaRemoveMarkButton () {
        ...
        if (instaRemoveMarksOn) document.getElementById("btInstaRemoveMarks").classList.remove("ext-disabled")
        else document.getElementById("btInstaRemoveMarks").classList.add("ext-disabled")
    ...
    function changeLanguage (bt) {
        ...
        if (bt.value == "CS") {
            ...
            document.getElementById("btCs").classList.remove("ext-disabled")
            document.getElementById("btEn").classList.add("ext-disabled")
            ...
            document.getElementById("btCs").classList.add("ext-disabled")
            document.getElementById("btEn").classList.remove("ext-disabled")
